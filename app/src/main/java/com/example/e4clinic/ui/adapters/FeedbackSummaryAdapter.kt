...
class FeedbackSummaryAdapter(val mAttachementsList:List<Int> =
    ...
    RecyclerView.Adapter<FeedbackSummaryAdapter.AttachementFilesViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FeedbackSummaryAdapter.AttachementFilesViewHolder =
        FeedbackSummaryAdapter.AttachementFilesViewHolder(
    ...
    override fun onBindViewHolder(
        holder: FeedbackSummaryAdapter.AttachementFilesViewHolder,
        position: Int
    ) =
